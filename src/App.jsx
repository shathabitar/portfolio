  ...
  return (
    <div>
      ...
      <Shelf 
          ...
          shelfData={[
            [
              { src: "../design/Coming soon.jpg", title: "Coming Soon", link:"../design/Coming soon.jpg" },
              ...
              { src: "../design/REMINDER!.jpg", title: "Reminder Poster", link:"../design/REMINDER!.jpg" },
              { src: "../design/FemPreneur Brochure.jpg", title: "FemPreneur Brochure", link:"../design/FemPreneur Brochure.jpg" }
            ],
            [
              { src: "../design/emc poster.png", title: "EMC Poster", link:"../design/emc poster.png" },
              { src: "../design/GDSC Lead.jpg", title: "GDSC Lead Poster", link:"https://www.instagram.com/p/C7TmqiuoR0A/?igsh=MTJ6dGg4cXRjdHI0Mg==" },
              { src: "../design/SCI FELLOWS.jpg", title: "SCI Fellows Poster", link:"../design/SCI FELLOWS.jpg" }
            ]
          ]}
      />
    ...
    <Shelf 
      ...
      <Shelf 
        ...
        shelfData={[
          [
            { src: "../application/Children police.png", title: "Children Police App", link: "../application/children police.mp4"}
          ]
        ]}
      />
